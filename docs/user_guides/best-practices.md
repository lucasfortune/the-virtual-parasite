...
- **Start processing** — Choose a module:
  - [Segmentation](modules/segmentation.md)
  - [DL Denoising](modules/denoising-dl.md)
  - [Filter Denoising](modules/denoising-filter.md)
  - [Annotation](modules/annotation.md)
- **Learn navigation** — [Help Navigation Guide](help-navigation.md)
- **Manage files** — [File Browser Guide](file-browser.md)
