...
For a conceptual overview, see [Annotation](info:annotation).

![Screenshot: Annotation module showing the painting interface with toolbar](screenshots/annotation-overview.png)
*Caption: The Annotation Tool interface with canvas, toolbar, and class management*
...
![Screenshot: Step 1 showing file selection options](screenshots/annotation-step1.png)
...
For more details, see [Source Image](info:annotation.step1.source-image).
...
![Screenshot: Step 2 interface with all areas labeled](screenshots/annotation-step2.png)
...
For more details, see [Annotation Tools](info:annotation.step2.tools).
...
![Screenshot: Brush size slider in toolbar](screenshots/annotation-brush-size.png)
...
For more details, see [Brush Size](info:annotation.step2.brush-size).
...
![Screenshot: Class panel showing multiple classes](screenshots/annotation-classes.png)
...
For more details, see [Annotation Classes](info:annotation.step2.classes).
...
![Screenshot: Slice navigation controls](screenshots/annotation-slice-nav.png)
...
**Module Overview:**
- [Quick Annotation Tool](info:annotation) — Module introduction and concepts

**Tools & Controls:**
- [Drawing Tools](info:annotation.step2.tools) — Brush and eraser details
- [Brush Size](info:annotation.step2.brush-size) — Size adjustment and shortcuts
- [Annotation Classes](info:annotation.step2.classes) — Adding and managing classes
- [History & Autosave](info:annotation.step2.history) — Undo/redo and automatic saving

**Data:**
- [Source Image Selection](info:annotation.step1.source-image) — Input requirements

---

## Next Steps

After creating annotations, you can:
- **Train a model** — Use your annotations as training data in the Segmentation module
- **Generate a mesh** — Convert your annotations directly to a 3D mesh
- **Edit later** — Return to edit mode to refine your annotations
