---
title: "Deep Learning Denoising Module Guide"
module: denoising-dl
version: "1.0.0"
---
...
![DL Denoising Module Overview](screenshots/denoising-dl-overview.png)
...
For method selection guidance, see [Denoising Method](info:denoising-dl.step1.method).
...
![Step 1 Method Selection](screenshots/denoising-dl-step1.png)
...
See [Denoising Method](info:denoising-dl.step1.method) for detailed guidance.
...
See [2D vs 2.5D Processing Mode](info:denoising-dl.step1.mode) for more details.
...
See [Input Data](info:denoising-dl.step1.input) for file requirements.
...
| File | Description |
|------|-------------|
| Config (.json) | Training configuration. See [Config File](info:denoising-dl.step1.import.config) |
| Model (.pth) | Trained model weights. See [Model File](info:denoising-dl.step1.import.model) |
...
![N2V Configuration](screenshots/denoising-dl-step2-n2v.png)
...
|----------|-----------|---------|--------------|
| **Dataset** | Patch Size | 64 | [Patch Size](info:denoising-dl.step2.patch-size) |
| | Patches per Image | 100 | [Patches per Image](info:denoising-dl.step2.patches-per-image) |
| | Batch Size | 8 | [Batch Size (DL Denoising)](info:denoising-dl.step2.batch-size) |
| | Mask Percentage | 15% | [Mask Percentage](info:denoising-dl.step2.mask-percentage) |
| | Data Augmentation | On | [Augmentation](info:denoising-dl.step2.augmentation) |
| **Architecture** | Number of Features | 64 | [Features](info:denoising-dl.step2.features) |
| | Number of Layers | 4 | [Number of Layers](info:denoising-dl.step2.num-layers) |
| **Training** | Learning Rate | 1e-4 | [Learning Rate (DL Denoising)](info:denoising-dl.step2.learning-rate) |
| | Epochs | 100 | [Epochs](info:denoising-dl.step2.epochs) |
| | Early Stopping | On | [Early Stopping](info:denoising-dl.step2.early-stopping) |

**Advanced Options** (collapsed by default):
- Resize Convolution: [Resize Conv](info:denoising-dl.step2.resize-conv)
- Upsampling Mode: [Upsampling Mode](info:denoising-dl.step2.upsampling-mode)
- Masking Strategy: [Masking Strategy](info:denoising-dl.step2.masking-strategy)

#### autoStructN2V Configuration (Dual Column)

For autoStructN2V, you'll see a side-by-side layout for both training stages:

![autoStructN2V Configuration](screenshots/denoising-dl-step2-autostructn2v.png)
...
|-----------|---------|-------------|--------------|
| Adaptive Thresholding | On | Automatically adjust threshold per slice | [Adaptive Thresholding](info:denoising-dl.step2.mask-extractor.adaptive) |
| Base Percentile | 50% | Starting threshold for noise detection | [Base Percentile](info:denoising-dl.step2.mask-extractor.base-percentile) |
| Percentile Decay | 1.15 | Rate at which threshold adapts | [Percentile Decay](info:denoising-dl.step2.mask-extractor.percentile-decay) |
| Max Masked Pixels | 25 | Maximum active pixels in the mask | [Max Masked Pixels](info:denoising-dl.step2.mask-extractor.max-pixels) |
...
![N2V Training](screenshots/denoising-dl-step3-n2v.png)
...
![autoStructN2V Training](screenshots/denoising-dl-step3-autostructn2v.png)
...
![Mask Extraction 2D](screenshots/denoising-dl-step3-mask-2d.png)
...
![Mask Extraction 2.5D](screenshots/denoising-dl-step3-mask-25d.png)
...
![Step 4 Inference](screenshots/denoising-dl-step4.png)
...
See [Inference Data](info:denoising-dl.step4.data) and [Inference Overview](info:denoising-dl.step4.overview).
...
For more details, see [N2V Training](info:denoising-dl.step3.n2v).
...
For more details, see [autoStructN2V Training](info:denoising-dl.step3.autostructn2v) and [autoStructN2V Details](info:denoising-dl.autostructn2v-detail).
...
### Module Overview
- [DL Denoising Overview](info:denoising-dl)

### Step 1: Method & Data Selection
- [Denoising Method](info:denoising-dl.step1.method)
- [2D vs 2.5D Processing Mode](info:denoising-dl.step1.mode)
- [Workflow Selection](info:denoising-dl.step1.workflow)
- [Input Data](info:denoising-dl.step1.input)
- [Import Config File](info:denoising-dl.step1.import.config)
- [Import Model File](info:denoising-dl.step1.import.model)

### Step 2: Configuration
- [Configuration Overview](info:denoising-dl.step2.overview)
- [Patch Size](info:denoising-dl.step2.patch-size)
- [Patches per Image](info:denoising-dl.step2.patches-per-image)
- [Batch Size (DL Denoising)](info:denoising-dl.step2.batch-size)
- [Mask Percentage](info:denoising-dl.step2.mask-percentage)
- [Augmentation](info:denoising-dl.step2.augmentation)
- [Features](info:denoising-dl.step2.features)
- [Number of Layers](info:denoising-dl.step2.num-layers)
- [Learning Rate (DL Denoising)](info:denoising-dl.step2.learning-rate)
- [Epochs](info:denoising-dl.step2.epochs)
- [Early Stopping](info:denoising-dl.step2.early-stopping)
- [ROI Selection](info:denoising-dl.step2.roi-selection)
- [Resize Convolution](info:denoising-dl.step2.resize-conv)
- [Upsampling Mode](info:denoising-dl.step2.upsampling-mode)
- [Masking Strategy](info:denoising-dl.step2.masking-strategy)

### Step 2: Mask Extractor (autoStructN2V)
- [Adaptive Thresholding](info:denoising-dl.step2.mask-extractor.adaptive)
- [Base Percentile](info:denoising-dl.step2.mask-extractor.base-percentile)
- [Percentile Decay](info:denoising-dl.step2.mask-extractor.percentile-decay)
- [Max Masked Pixels](info:denoising-dl.step2.mask-extractor.max-pixels)

### Step 3: Training
- [Training Overview](info:denoising-dl.step3.overview)
- [N2V Training](info:denoising-dl.step3.n2v)
- [autoStructN2V Training](info:denoising-dl.step3.autostructn2v)
- [Loss Metrics](info:denoising-dl.step3.loss)
- [Best Validation Loss](info:denoising-dl.step3.best-val-loss)
- [autoStructN2V Details](info:denoising-dl.autostructn2v-detail)

### Step 4: Inference
- [Inference Overview](info:denoising-dl.step4.overview)
- [Inference Data](info:denoising-dl.step4.data)
...
- **View results** — Use the Image Viewer to compare before/after
- **Segment denoised images** — Use the Segmentation module for cleaner segmentation
- **Export model** — Download your trained model to use on other data
