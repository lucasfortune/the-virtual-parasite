...
![Welcome Page Layout](/guides/getting-started-welcome-layout.png)
...
![Workspace Layout](/guides/getting-started-workspace-layout.png)
...
Browse and manage files in your workspace. See the [File Browser Guide](/workspace/guides/file-browser) for details.
...
![Module Cards](/guides/getting-started-module-cards.png)
...
![Info Panel](/guides/getting-started-info-panel.png)
...
For more details, see the [Help & Info Guide](/workspace/guides/info-help).
...
![Module View](/guides/getting-started-module-view.png)
