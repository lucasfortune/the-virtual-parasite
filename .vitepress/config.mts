...
export default defineConfig({
  ...
  rewrites: {
    ...
    'src/workspace/guides/preprocessing.md': 'workspace/guides/preprocessing.md',
    'src/workspace/guides/segmentation-cleanup.md': 'workspace/guides/segmentation-cleanup.md',
    'src/workspace/guides/stack-stitching.md': 'workspace/guides/stack-stitching.md',
      ...
      '/workspace/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Preprocessing Module', link: '/workspace/guides/preprocessing' },
            ...
            { text: 'Segmentation Cleanup Module', link: '/workspace/guides/segmentation-cleanup' },
            { text: 'Stack Stitching Module', link: '/workspace/guides/stack-stitching' },
          ...
          items: [
            {
              ...
              collapsed: true,
              items: [
                { text: 'Workspace Basics', link: '/workspace/docs/workspace-basics' },
                { text: 'Getting Started with Help', link: '/workspace/docs/getting-started' },
              ]
            },
            {
              text: 'Image Viewer',
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Module Overview', link: '/workspace/docs/modules/preprocess/_module' },
                { text: 'Select Stack', link: '/workspace/docs/modules/preprocess/step1-stack' },
                { text: 'Crop and Z Range', link: '/workspace/docs/modules/preprocess/step2-crop' },
                { text: 'Geometry', link: '/workspace/docs/modules/preprocess/step2-geometry' },
                { text: 'Intensity', link: '/workspace/docs/modules/preprocess/step2-intensity' },
                { text: 'Output', link: '/workspace/docs/modules/preprocess/step2-output' },
              ]
            },
            {
              ...
              items: [
                ...
                { text: 'Routing Decision', link: '/workspace/docs/modules/denoising-dl/routing-decision' },
                { text: 'Denoising Methods', link: '/workspace/docs/modules/denoising-dl/step1-method' },
                { text: 'Legacy 2.5D Models', link: '/workspace/docs/modules/denoising-dl/step1-mode' },
                ...
                { text: 'Background Side', link: '/workspace/docs/modules/denoising-dl/step2-mask-extractor-bg-side' },
                { text: 'Correlation Floor', link: '/workspace/docs/modules/denoising-dl/step2-mask-extractor-rho-floor' },
                { text: 'Significance Threshold (|z|)', link: '/workspace/docs/modules/denoising-dl/step2-mask-extractor-spine-thresh' },
                { text: 'Max Mask Pixels', link: '/workspace/docs/modules/denoising-dl/step2-mask-extractor-max-pixels' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Processing & Results', link: '/workspace/docs/modules/denoising-filter/step3' },
              ]
            },
            {
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Training Configuration', link: '/workspace/docs/modules/segmentation/step2' },
            ...
            {
              text: 'Segmentation Cleanup',
              collapsed: true,
              items: [
                { text: 'Module Overview', link: '/workspace/docs/modules/segcleanup/_module' },
                { text: 'Selecting a Segmentation', link: '/workspace/docs/modules/segcleanup/step1-segmentation' },
                { text: 'Painting Corrections', link: '/workspace/docs/modules/segcleanup/step2-painting' },
                { text: 'Automated Cleanup', link: '/workspace/docs/modules/segcleanup/step2-cleanup-ops' },
                { text: 'Quantification and Reports', link: '/workspace/docs/modules/segcleanup/step2-quantification' },
                { text: 'Saving the Result', link: '/workspace/docs/modules/segcleanup/step2-save' },
              ]
            },
            {
              text: 'Stack Stitching',
              collapsed: true,
              items: [
                { text: 'Module Overview', link: '/workspace/docs/modules/stitching/_module' },
                { text: 'New Stitch or Saved Recipe', link: '/workspace/docs/modules/stitching/step1-workflow' },
                { text: 'Selecting and Ordering Stacks', link: '/workspace/docs/modules/stitching/step1-stacks' },
                { text: 'Applying a Saved Recipe', link: '/workspace/docs/modules/stitching/step1-recipe' },
                { text: 'Choosing the Slice Pair', link: '/workspace/docs/modules/stitching/step2-slice-pair' },
                { text: 'The Overlay Viewer', link: '/workspace/docs/modules/stitching/step2-controls' },
                { text: 'Aligning a Junction', link: '/workspace/docs/modules/stitching/step2-auto-align' },
                { text: 'Overlapping Sections Keep', link: '/workspace/docs/modules/stitching/step2-dominance' },
                { text: 'Composing the Volume', link: '/workspace/docs/modules/stitching/step3-compose' },
              ]
            },
            {
